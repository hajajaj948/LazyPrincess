...
API_ID = int(environ['13413587'])
API_HASH = environ['fa2829fb6fb89a42f0d3ad78bd4d8cb8']
BOT_TOKEN = environ['6493798968:AAFlmOG0I6S9-4zoJZaIOdMpvVF7eS79Ksw']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1085998540').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002038797131').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1001398786468')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wixoh61093:E7LSrvkiaq3X1uCu@cluster0.yjizf0a.mongodb.net/?retryWrites=true&w=majority")
